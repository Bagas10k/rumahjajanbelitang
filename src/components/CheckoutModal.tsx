...
import { X, CheckCircle, Truck, Wallet, Printer } from 'lucide-react';
  ...
  const handleConfirmCheckout = async () => {
    ...
    try {
      ...
      if (order) {
        ...
        // Record order in financial store
        useFinancialStore.getState().recordOrderIncome(order);
        setStep('success');
      } else {
              ...
              <div className="text-center space-y-6 py-6 max-w-sm mx-auto">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-3 bg-[#2d2218] hover:bg-gray-800 text-white font-bold text-xs rounded-xl cursor-pointer flex items-center justify-center gap-1.5 shadow-xs"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 py-3 bg-[#e28743] hover:bg-[#c97435] text-white font-extrabold text-xs rounded-xl cursor-pointer transition-colors shadow-xs"
                  >
                    Selesai
                  </button>
                </div>
